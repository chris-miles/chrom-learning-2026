...
- `paper_figures/` — **Primary interface for paper output.** Figure-assembler notebooks for the main text and supplement, with rendered outputs in `paper_figures/rendered/` (`.ipynb` for code review, code-free `.html` for sharing with co-authors). Regenerate with `bash scripts/execute_notebooks.sh`.
  - **Read the rendered figures + captions in your browser:**
    - Main text: [`00_main_figure.html`](https://htmlpreview.github.io/?https://github.com/chris-miles/chrom-learning-2026/blob/master/paper_figures/rendered/00_main_figure.html)
    - Supplement: [`00b_supplement.html`](https://htmlpreview.github.io/?https://github.com/chris-miles/chrom-learning-2026/blob/master/paper_figures/rendered/00b_supplement.html)
...
- `exploratory_notebooks/` — Internal analysis pipeline that the paper-figure assemblers consume. These are not paper-facing; they live here so a curious reader can drill into the underlying analysis. Auto-generated `.ipynb` files (without executed outputs) sit in `exploratory_notebooks/ipynb/`.
