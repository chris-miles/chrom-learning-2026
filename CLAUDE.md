...
- `stable-apr3-2026` — Stable baseline before substantive changes (commit `deff017`). All notebooks, CV pipeline, and short-range xx test working. Roll back with `git checkout stable-apr3-2026`.
